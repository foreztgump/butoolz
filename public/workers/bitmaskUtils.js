 ...
 */
export const shapeStringToBitmask = (shapeString) => {
 ...
 */
export const isValidPlacement = (gridState, shapePlacement) => {
 ...
 */
export const placeShape = (gridState, shapePlacement) => {
 ...
 */
export const removeShape = (gridState, shapePlacement) => {
 ...
 */
export const isGridFull = (gridState) => {
 ...
 */
export const rotateShapeBitmask = (shapeMask) => {
    let rotatedMask = 0n;
 ...
 */
export const reflectShapeBitmask = (shapeMask) => {
 ...
 */
export const generateUniqueOrientations = (baseShapeMask) => {
 ...
 */
export const getCanonicalShape = (shapeMask) => {
    if (shapeMask === 0n) {
        return 0n;
    }
 ...
 */
export const bitmaskToTileIds = (bitmask) => {
    const tileIds = [];
    for (let i = 0; i < TOTAL_TILES; i++) {
 ...
 */
export const findLowestSetBitIndex = (mask) => {
    if (mask === 0n) {
        return -1;
    }
    let index = 0;
 ...
 */
export const translateShapeBitmask = (shapeMask, deltaQ, deltaR) => {
 ...
 */
export const countSetBits = (mask) => {
    let count = 0;
    let tempMask = mask;
    while (tempMask > 0n) {
