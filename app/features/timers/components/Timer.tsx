  ...
  const baseSliderWidthPx = 40;
   ...
   useEffect(() => {
      ...
      const tick = () => {
          ...
          if (newTimeLeft <= 0) {
              const playFinalSound = preset.completionTime !== undefined && preset.completionTime === 0 && !soundPlayedThisTick && !isMuted && isAudioReady;
              if (playFinalSound) {
                    ...
                    else if (localAudioMode === 'beep') finalSoundToPlay = 'beep-long';
